...
<Frame caption="The three planes: the contracts on Hedera, the enclave that signs verdicts, and the ways in.">
  <img src="https://cdn.jsdelivr.net/gh/AbhimanyuAjudiya/bond-desk@main/mintlify/images/chart-architecture.png" alt="Architecture: Hedera testnet, the Chainlink CRE enclave, and delivery" />
</Frame>
